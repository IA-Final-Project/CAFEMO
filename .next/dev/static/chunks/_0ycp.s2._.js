...
"[project]/src/components/Kiosk.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const TypewriterMessage = ({ text, onComplete, fastForward, onUpdate })=>{
    _s();
    ...
    const isFinished = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TypewriterMessage.useEffect": ()=>{
            ...
            const timer = setInterval({
                "TypewriterMessage.useEffect.timer": ()=>{
            ...
            }["TypewriterMessage.useEffect.timer"], 15);
            return ({
                "TypewriterMessage.useEffect": ()=>clearInterval(timer)
            })["TypewriterMessage.useEffect"];
        }
    }["TypewriterMessage.useEffect"], [
        text,
...
_s(TypewriterMessage, "jf7uUMTVI+KptkJXVCYVNj2mhHU=");
...
const Kiosk = ()=>{
    ...
    const [fastForward, setFastForward] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [messages, setMessages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        {
            id: 1,
            sender: 'Meowow',
            text: "Hello and welcome to CafeMo! Looking for something?",
            typewriter: true,
            options: [
                'Recommend me a drink!',
                'Show me all the menu!'
            ]
        }
    ]);
    const [orderStage, setOrderStage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('GATHERING');
    ...
    const handleTypingComplete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Kiosk.useCallback[handleTypingComplete]": ()=>{
            setIsTyping(false);
        }
    }["Kiosk.useCallback[handleTypingComplete]"], []);
    const handleTypingUpdate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Kiosk.useCallback[handleTypingUpdate]": ()=>{
            messagesEndRef.current?.scrollIntoView({
                behavior: 'auto'
            });
        }
    ...
    const handleSend = async (overrideText)=>{
        ...
        try {
            ...
            const systemPrompt = `You are Meowow, an intelligent, friendly barista mascot at CafeMo acting as an interactive AI kiosk. Keep responses strictly under 2 sentences. Be cheerful. 
CRITICAL: You MUST provide EXACTLY 1-3 short interactive choices for the user to respond with at the very end of your response formatted like this: [OPTIONS: Opt 1 | Opt 2 | Opt 3]. Make the first option the primary/confirmation choice.
CRITICAL: If you are actively recommending a specific drink, you MUST output [IMAGE: drink_name] exactly once in your response. 
CRITICAL: When the customer has confirmed their customized order and is fully ready to place it, you MUST append the exact string '[FINALIZED]' at the very end. Never use markdown.`;
            ...
            if (imageMatch) {
                imageUrl = '/frappe.png'; // Using our generated placeholder strictly
                aiResponse = aiResponse.replace(/\[IMAGE:.*?\]/ig, '').trim();
            }
            let parsedOptions = [];
            const optionsMatch = aiResponse.match(/\[OPTIONS:\s*(.*?)\]/i);
            if (optionsMatch) {
                parsedOptions = optionsMatch[1].split('|').map((s)=>s.trim());
                aiResponse = aiResponse.replace(/\[OPTIONS:.*?\]/ig, '').trim();
            } else {
                // Fallback if LLM forgets
                parsedOptions = isFinalized ? [] : [
                    "I'll take it!",
                    "Actually no"
                ];
            }
            ...
            setMessages((prev)=>[
                    ...prev,
                    {
                        ...
                        text: aiResponse,
                        image: imageUrl,
                        options: isFinalized ? [] : parsedOptions,
                        typewriter: true
                    }
                ]);
            if (isFinalized) {
                setOrderStage('PROCESSING');
                const timeToWait = aiResponse.length * 15 + 1000;
                setTimeout(()=>{
                    setMessages((prev)=>[
                            ...prev,
                            {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex w-full h-[100dvh] bg-[#f7ead6] items-center justify-center overflow-hidden relative font-sans",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "relative w-full max-w-[1300px] h-full flex flex-row items-end z-10 px-8 lg:px-16 pb-12 pt-12",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "w-[35%] h-full flex items-end justify-end pointer-events-none z-20 pb-0 shrink-0 -mr-16 -mb-8",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                        src: isTyping ? "/placeholder.gif" : "/placeholder.png",
                        alt: "Mascot Avatar",
                        className: "w-[220%] max-w-[1200px] min-w-[550px] translate-x-24 translate-y-[20%] object-contain transition-all"
                    }, void 0, false, {
                        fileName: "[project]/src/components/Kiosk.jsx",
                        lineNumber: 226,
                        columnNumber: 11
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "w-[65%] h-[90%] flex flex-col justify-end z-30 relative",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        onClick: handleBubbleClick,
                        className: `relative w-full h-full bg-[#a3c2b1] rounded-[2.5rem] p-10 flex flex-col shadow-lg border-4 border-[#94b1a1] ${isTyping ? 'cursor-pointer' : ''}`,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute bottom-[20%] -left-[60px] w-0 h-0 border-y-[18px] border-y-transparent border-r-[60px] border-r-[#94b1a1]"
                            }, void 0, false, {
                                fileName: "[project]/src/components/Kiosk.jsx",
                                lineNumber: 242,
                                columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute bottom-[20%] mt-[4px] -left-[54px] w-0 h-0 border-y-[14px] border-y-transparent border-r-[54px] border-r-[#a3c2b1] z-10"
                            }, void 0, false, {
                                fileName: "[project]/src/components/Kiosk.jsx",
                                lineNumber: 243,
                                columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex-1 overflow-y-auto flex flex-col gap-6 pr-4 pl-2 mb-6 min-h-0 no-scrollbar",
                                style: {
                                    scrollbarWidth: 'none',
                                ...
                                children: [
                                    messages.map((msg, index)=>{
                                        const isLatest = index >= messages.length - 1; // Show options only on absolute latest message
                                        if (msg.sender === 'user') {
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex flex-col items-end w-full animate-in fade-in slide-in-from-bottom-2 duration-300",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "text-[#4e4d69] font-bold mb-1 opacity-70 text-sm tracking-wide",
                                                        children: "You"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/Kiosk.jsx",
                                                        lineNumber: 253,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "text-xl font-bold text-white bg-[#737199] px-6 py-4 rounded-3xl rounded-tr-sm shadow-md max-w-[80%] whitespace-pre-line leading-relaxed",
                                                        children: msg.text
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/Kiosk.jsx",
                                                        lineNumber: 254,
                                        ...
                                        if (msg.isSystem) {
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-lg font-bold text-white/70 bg-black/20 px-5 py-2 rounded-xl text-center",
                                                    children: msg.text
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/Kiosk.jsx",
                                                    lineNumber: 264,
                                        ...
                                        // Meowow's layout
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: `flex flex-col items-start w-full ${!isLatest ? 'opacity-80' : 'opacity-100'} transition-all duration-300`,
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-[#4a5d53] font-bold mb-1 opacity-70 text-sm tracking-wide",
                                                    children: "Meowow"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/Kiosk.jsx",
                                                    lineNumber: 274,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex flex-col items-start bg-[#e9f2ee] px-8 py-6 rounded-[2rem] rounded-tl-sm shadow-sm w-full max-w-[90%]",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "text-2xl font-bold text-[#4a5d53] leading-relaxed mb-4",
                                                            children: msg.typewriter ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TypewriterMessage, {
                                                                text: msg.text,
                                                        ...
                                                        msg.image && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "w-full flex justify-center py-4 mb-4",
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                                src: msg.image,
                                                                className: "w-[180px] h-[180px] object-contain drop-shadow-md animate-in zoom-in spin-in-2 duration-500",
                                                                alt: "Generated Drink"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/Kiosk.jsx",
                                                                lineNumber: 288,
                                                        ...
                                                        msg.options && msg.options.length > 0 && isLatest && !isTyping && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "flex flex-wrap gap-3 mt-4 w-full justify-center animate-in fade-in slide-in-from-bottom-4 duration-500 delay-150",
                                                            children: msg.options.map((opt, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    onClick: (e)=>{
                                                                        e.stopPropagation();
                                                                        handleSend(opt);
                                                                    },
                                                                    className: `px-6 py-3 rounded-full text-lg font-bold text-white hover:scale-105 active:scale-95 transition-all shadow-md
                                  ${i === 0 ? 'bg-[#e07a5f] hover:bg-[#d4694f]' : 'bg-[#737199] hover:bg-[#605e83]'}`,
                                                                    children: opt
                                                                }, i, false, {
                                                                    fileName: "[project]/src/components/Kiosk.jsx",
                                                                    lineNumber: 296,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex items-center gap-3 shrink-0 bg-[#e9f2ee] rounded-full p-2 px-6 shadow-inner mx-2 opacity-80 focus-within:opacity-100 transition-opacity",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        placeholder: orderStage === 'COMPLETED' ? "Order finished!" : "Send Message here...",
                                        className: "w-full bg-transparent py-4 text-xl outline-none font-bold text-[#4a5d53] placeholder:text-[#4a5d53]/50 disabled:opacity-50 italic"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/Kiosk.jsx",
                                        lineNumber: 315,
                                        columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        disabled: orderStage === 'COMPLETED' || isTyping || !inputText.trim(),
                                        className: "p-3 bg-[#737199] text-white hover:bg-[#605e83] disabled:opacity-50 disabled:hover:bg-[#737199] rounded-full transition-colors cursor-pointer shrink-0",
...
//# sourceMappingURL=_0ycp.s2._.js.map